...
from citybrain.utils import Singleton
from citybrain.utils.file_utils import assemble_project_path, get_project_root
...
class Config(metaclass=Singleton):
    ...
    DEFAULT_GAME_RESOLUTION = (1926, 1120)
    ...
    DEFAULT_OCR_CROP_REGION = (380, 720, 1926, 1120) # x1, y1, x2, y2, from top left to bottom right
    ...
    def _set_game_window_info(self):
        ...
        if len(named_windows) == 0:
            ...
            assert game_window.width >= self.DEFAULT_GAME_RESOLUTION[0] and game_window.height >= self.DEFAULT_GAME_RESOLUTION[1], 'The resolution of screen should at least be 1926 X 1120.'
